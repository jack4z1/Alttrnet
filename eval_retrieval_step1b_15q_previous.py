...
QUESTIONS = [
    ...
    },
    {
        ...
        "question": "What does the Python tutorial say about Python's use for scripting and rapid application development?",
        "expected_source": "https://docs.python.org/3/tutorial/",
        "expected_label": "Python documentation",
    },
    {
        "source": "Python",
        "type": "Keyword-heavy",
        "question": "What does the Python tutorial say about Python's syntax, dynamic typing, and high-level data structures?",
        "expected_source": "https://docs.python.org/3/tutorial/",
        "expected_label": "Python documentation",
    },
    {
        "source": "Python",
        "type": "Conceptual",
        "question": "Why is Python described as being easy to learn?",
        "expected_source": "https://docs.python.org/3/tutorial/",
        "expected_label": "Python documentation",
    },
    {
        "source": "Python",
        "type": "Specific",
        "question": "What does the Python tutorial say about the Python interpreter and standard library?",
        "expected_source": "https://docs.python.org/3/tutorial/",
        "expected_label": "Python documentation",
    },
    # --- RAG Wikipedia (6-10) ---
    ...
    },
    {
        "source": "Ollama",
        "type": "Specific factual",
        "question": "What operating systems does Ollama support according to the source?",
        "expected_source": "https://en.wikipedia.org/wiki/Ollama",
        "expected_label": "Ollama Wikipedia article",
    },
    {
        "source": "Ollama",
        "type": "Keyword-heavy",
        "question": "What tools and interfaces does Ollama provide for running and managing language models?",
        "expected_source": "https://en.wikipedia.org/wiki/Ollama",
        "expected_label": "Ollama Wikipedia article",
    },
    {
        "source": "Ollama",
        "type": "Conceptual",
        "question": "What is Ollama intended to make easier for users?",
        "expected_source": "https://en.wikipedia.org/wiki/Ollama",
        "expected_label": "Ollama Wikipedia article",
    },
    {
        "source": "Ollama",
        "type": "Specific",
        "question": "What programming language is Ollama written in according to the source?",
        "expected_source": "https://en.wikipedia.org/wiki/Ollama",
        "expected_label": "Ollama Wikipedia article",
    },
]
